      ...
      messages: [
        {
          ...
          value: new Uint8Array([
            ...
            119, 57, 99, 119, 120, 107, 26, 13, 10, 4, 117, 114, 105, 111, 18,
            5, 53, 48, 48, 48, 48,
          ]),
        },
      ],
  ...
  it('createSigDoc test', () => {
    ...
    expect(res.toObject()).toStrictEqual({
      body_bytes: new Uint8Array([
        ...
        122, 55, 50, 119, 51, 101, 114, 108, 120, 99, 104, 51, 113, 57, 104,
        119, 57, 99, 119, 120, 107, 26, 13, 10, 4, 117, 114, 105, 111, 18, 5,
        49, 48, 48, 48, 49, 18, 4, 116, 101, 115, 116,
      ]),
      auth_info_bytes: new Uint8Array([
        ...
        117, 176, 131, 35, 18, 4, 10, 2, 8, 1, 24, 0, 18, 16, 10, 10, 10, 4,
        117, 114, 105, 111, 18, 2, 50, 48, 16, 160, 156, 1,
      ]),
      chain_id: chainId,
