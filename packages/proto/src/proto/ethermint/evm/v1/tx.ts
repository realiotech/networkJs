...
export namespace ethermint.evm.v1 {
    ...
    export abstract class UnimplementedMsgService {
        static definition = {
            EthereumTx: {
                ...
                requestSerialize: (message: MsgEthereumTx) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => MsgEthereumTx.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: MsgEthereumTxResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => MsgEthereumTxResponse.deserialize(new Uint8Array(bytes))
            },
            UpdateParams: {
    ...
    export class MsgClient extends grpc_1.makeGenericClientConstructor(UnimplementedMsgService.definition, "Msg", {}) {
        ...
        EthereumTx: GrpcUnaryServiceInterface<MsgEthereumTx, MsgEthereumTxResponse> = (message: MsgEthereumTx, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<MsgEthereumTxResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<MsgEthereumTxResponse>, callback?: grpc_1.requestCallback<MsgEthereumTxResponse>): grpc_1.ClientUnaryCall => {
