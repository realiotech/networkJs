...
export namespace ethermint.evm.v1 {
    ...
    export abstract class UnimplementedQueryService {
        static definition = {
            ...
            EthCall: {
                ...
                responseSerialize: (message: dependency_3.ethermint.evm.v1.MsgEthereumTxResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => dependency_3.ethermint.evm.v1.MsgEthereumTxResponse.deserialize(new Uint8Array(bytes))
            },
            EstimateGas: {
            ...
            TraceTx: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: QueryTraceTxRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => QueryTraceTxRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: QueryTraceTxResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => QueryTraceTxResponse.deserialize(new Uint8Array(bytes))
            },
            TraceBlock: {
                path: "/ethermint.evm.v1.Query/TraceBlock",
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: QueryTraceBlockRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => QueryTraceBlockRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: QueryTraceBlockResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => QueryTraceBlockResponse.deserialize(new Uint8Array(bytes))
            },
            BaseFee: {
        ...
        abstract EthCall(call: grpc_1.ServerUnaryCall<EthCallRequest, dependency_3.ethermint.evm.v1.MsgEthereumTxResponse>, callback: grpc_1.sendUnaryData<dependency_3.ethermint.evm.v1.MsgEthereumTxResponse>): void;
    ...
    export class QueryClient extends grpc_1.makeGenericClientConstructor(UnimplementedQueryService.definition, "Query", {}) {
        ...
        EthCall: GrpcUnaryServiceInterface<EthCallRequest, dependency_3.ethermint.evm.v1.MsgEthereumTxResponse> = (message: EthCallRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<dependency_3.ethermint.evm.v1.MsgEthereumTxResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<dependency_3.ethermint.evm.v1.MsgEthereumTxResponse>, callback?: grpc_1.requestCallback<dependency_3.ethermint.evm.v1.MsgEthereumTxResponse>): grpc_1.ClientUnaryCall => {
        ...
        TraceTx: GrpcUnaryServiceInterface<QueryTraceTxRequest, QueryTraceTxResponse> = (message: QueryTraceTxRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<QueryTraceTxResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<QueryTraceTxResponse>, callback?: grpc_1.requestCallback<QueryTraceTxResponse>): grpc_1.ClientUnaryCall => {
            return super.TraceTx(message, metadata, options, callback);
        };
        TraceBlock: GrpcUnaryServiceInterface<QueryTraceBlockRequest, QueryTraceBlockResponse> = (message: QueryTraceBlockRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<QueryTraceBlockResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<QueryTraceBlockResponse>, callback?: grpc_1.requestCallback<QueryTraceBlockResponse>): grpc_1.ClientUnaryCall => {
