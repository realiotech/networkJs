...
export namespace cosmos.base.abci.v1beta1 {
    ...
    export class Result extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            log?: string;
            events?: dependency_2.tendermint.abci.Event[];
            msg_responses?: dependency_3.google.protobuf.Any[];
        }) {
            super();
        ...
        set msg_responses(value: dependency_3.google.protobuf.Any[]) {
        ...
        static fromObject(data: {
            ...
            log?: string;
            events?: ReturnType<typeof dependency_2.tendermint.abci.Event.prototype.toObject>[];
            msg_responses?: ReturnType<typeof dependency_3.google.protobuf.Any.prototype.toObject>[];
        }): Result {
            ...
            if (data.msg_responses != null) {
                message.msg_responses = data.msg_responses.map(item => dependency_3.google.protobuf.Any.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.msg_responses != null) {
                data.msg_responses = this.msg_responses.map((item: dependency_3.google.protobuf.Any) => item.toObject());
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.msg_responses.length)
                writer.writeRepeatedMessage(4, this.msg_responses, (item: dependency_3.google.protobuf.Any) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        reader.readMessage(message.msg_responses, () => pb_1.Message.addToRepeatedWrapperField(message, 4, dependency_3.google.protobuf.Any.deserialize(reader), dependency_3.google.protobuf.Any));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class TxMsgData extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.msg_responses.length)
                writer.writeRepeatedMessage(2, this.msg_responses, (item: dependency_3.google.protobuf.Any) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.msg_responses, () => pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_3.google.protobuf.Any.deserialize(reader), dependency_3.google.protobuf.Any));
                        break;
                    default: reader.skipField();
                }
            }
