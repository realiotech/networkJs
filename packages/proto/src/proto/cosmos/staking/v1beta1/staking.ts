...
export namespace cosmos.staking.v1beta1 {
    ...
    export class UnbondingDelegationEntry extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            initial_balance?: dependency_6.cosmos.base.v1beta1.Coin;
        ...
        get initial_balance() {
            return pb_1.Message.getWrapperField(this, dependency_6.cosmos.base.v1beta1.Coin, 3) as dependency_6.cosmos.base.v1beta1.Coin;
        }
        set initial_balance(value: dependency_6.cosmos.base.v1beta1.Coin) {
            pb_1.Message.setWrapperField(this, 3, value);
        }
        get has_initial_balance() {
            return pb_1.Message.getField(this, 3) != null;
        }
        get balance() {
            return pb_1.Message.getWrapperField(this, dependency_6.cosmos.base.v1beta1.Coin, 4) as dependency_6.cosmos.base.v1beta1.Coin;
        }
        ...
        static fromObject(data: {
            ...
            initial_balance?: ReturnType<typeof dependency_6.cosmos.base.v1beta1.Coin.prototype.toObject>;
            ...
            if (data.initial_balance != null) {
                message.initial_balance = dependency_6.cosmos.base.v1beta1.Coin.fromObject(data.initial_balance);
            }
        ...
        toObject() {
            ...
            if (this.initial_balance != null) {
                data.initial_balance = this.initial_balance.toObject();
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_initial_balance)
                writer.writeMessage(3, this.initial_balance, () => this.initial_balance.serialize(writer));
            if (this.has_balance)
                writer.writeMessage(4, this.balance, () => this.balance.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        reader.readMessage(message.initial_balance, () => message.initial_balance = dependency_6.cosmos.base.v1beta1.Coin.deserialize(reader));
                        break;
                    case 4:
