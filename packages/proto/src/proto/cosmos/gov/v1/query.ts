...
import * as dependency_3 from "./gov";
...
export namespace cosmos.gov.v1 {
    ...
    export class QueryProposalResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            proposal?: dependency_3.cosmos.gov.v1.Proposal;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get proposal() {
            return pb_1.Message.getWrapperField(this, dependency_3.cosmos.gov.v1.Proposal, 1) as dependency_3.cosmos.gov.v1.Proposal;
        }
        set proposal(value: dependency_3.cosmos.gov.v1.Proposal) {
        ...
        static fromObject(data: {
            proposal?: ReturnType<typeof dependency_3.cosmos.gov.v1.Proposal.prototype.toObject>;
        }): QueryProposalResponse {
            const message = new QueryProposalResponse({});
            if (data.proposal != null) {
                message.proposal = dependency_3.cosmos.gov.v1.Proposal.fromObject(data.proposal);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryProposalResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.proposal, () => message.proposal = dependency_3.cosmos.gov.v1.Proposal.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class QueryProposalsRequest extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            proposal_status?: dependency_3.cosmos.gov.v1.ProposalStatus;
            voter?: string;
            depositor?: string;
        ...
        get proposal_status() {
            return pb_1.Message.getFieldWithDefault(this, 1, dependency_3.cosmos.gov.v1.ProposalStatus.PROPOSAL_STATUS_UNSPECIFIED) as dependency_3.cosmos.gov.v1.ProposalStatus;
        }
        set proposal_status(value: dependency_3.cosmos.gov.v1.ProposalStatus) {
            pb_1.Message.setField(this, 1, value);
        }
        get voter() {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.proposal_status != dependency_3.cosmos.gov.v1.ProposalStatus.PROPOSAL_STATUS_UNSPECIFIED)
    ...
    export class QueryProposalsResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            proposals?: dependency_3.cosmos.gov.v1.Proposal[];
        ...
        get proposals() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_3.cosmos.gov.v1.Proposal, 1) as dependency_3.cosmos.gov.v1.Proposal[];
        }
        set proposals(value: dependency_3.cosmos.gov.v1.Proposal[]) {
        ...
        static fromObject(data: {
            proposals?: ReturnType<typeof dependency_3.cosmos.gov.v1.Proposal.prototype.toObject>[];
            ...
            if (data.proposals != null) {
                message.proposals = data.proposals.map(item => dependency_3.cosmos.gov.v1.Proposal.fromObject(item));
            }
            if (data.pagination != null) {
        ...
        toObject() {
            ...
            if (this.proposals != null) {
                data.proposals = this.proposals.map((item: dependency_3.cosmos.gov.v1.Proposal) => item.toObject());
            }
            if (this.pagination != null) {
                data.pagination = this.pagination.toObject();
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.proposals.length)
                writer.writeRepeatedMessage(1, this.proposals, (item: dependency_3.cosmos.gov.v1.Proposal) => item.serialize(writer));
            if (this.has_pagination)
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryProposalsResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.proposals, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_3.cosmos.gov.v1.Proposal.deserialize(reader), dependency_3.cosmos.gov.v1.Proposal));
                        break;
                    case 2:
    ...
    export class QueryVoteResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            vote?: dependency_3.cosmos.gov.v1.Vote;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get vote() {
            return pb_1.Message.getWrapperField(this, dependency_3.cosmos.gov.v1.Vote, 1) as dependency_3.cosmos.gov.v1.Vote;
        }
        set vote(value: dependency_3.cosmos.gov.v1.Vote) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        get has_vote() {
            return pb_1.Message.getField(this, 1) != null;
        ...
        static fromObject(data: {
            vote?: ReturnType<typeof dependency_3.cosmos.gov.v1.Vote.prototype.toObject>;
        }): QueryVoteResponse {
            const message = new QueryVoteResponse({});
            if (data.vote != null) {
                message.vote = dependency_3.cosmos.gov.v1.Vote.fromObject(data.vote);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryVoteResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.vote, () => message.vote = dependency_3.cosmos.gov.v1.Vote.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class QueryVotesResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            votes?: dependency_3.cosmos.gov.v1.Vote[];
            pagination?: dependency_1.cosmos.base.query.v1beta1.PageResponse;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], this.#one_of_decls);
        ...
        get votes() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_3.cosmos.gov.v1.Vote, 1) as dependency_3.cosmos.gov.v1.Vote[];
        }
        set votes(value: dependency_3.cosmos.gov.v1.Vote[]) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        get pagination() {
            return pb_1.Message.getWrapperField(this, dependency_1.cosmos.base.query.v1beta1.PageResponse, 2) as dependency_1.cosmos.base.query.v1beta1.PageResponse;
        ...
        static fromObject(data: {
            votes?: ReturnType<typeof dependency_3.cosmos.gov.v1.Vote.prototype.toObject>[];
            pagination?: ReturnType<typeof dependency_1.cosmos.base.query.v1beta1.PageResponse.prototype.toObject>;
        }): QueryVotesResponse {
            const message = new QueryVotesResponse({});
            if (data.votes != null) {
                message.votes = data.votes.map(item => dependency_3.cosmos.gov.v1.Vote.fromObject(item));
            }
            if (data.pagination != null) {
                message.pagination = dependency_1.cosmos.base.query.v1beta1.PageResponse.fromObject(data.pagination);
            }
        ...
        toObject() {
            ...
            if (this.votes != null) {
                data.votes = this.votes.map((item: dependency_3.cosmos.gov.v1.Vote) => item.toObject());
            }
            if (this.pagination != null) {
                data.pagination = this.pagination.toObject();
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.votes.length)
                writer.writeRepeatedMessage(1, this.votes, (item: dependency_3.cosmos.gov.v1.Vote) => item.serialize(writer));
            if (this.has_pagination)
                writer.writeMessage(2, this.pagination, () => this.pagination.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryVotesResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.votes, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_3.cosmos.gov.v1.Vote.deserialize(reader), dependency_3.cosmos.gov.v1.Vote));
                        break;
                    case 2:
                        reader.readMessage(message.pagination, () => message.pagination = dependency_1.cosmos.base.query.v1beta1.PageResponse.deserialize(reader));
                        break;
    ...
    export class QueryParamsResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            voting_params?: dependency_3.cosmos.gov.v1.VotingParams;
            deposit_params?: dependency_3.cosmos.gov.v1.DepositParams;
            tally_params?: dependency_3.cosmos.gov.v1.TallyParams;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get voting_params() {
            return pb_1.Message.getWrapperField(this, dependency_3.cosmos.gov.v1.VotingParams, 1) as dependency_3.cosmos.gov.v1.VotingParams;
        }
        set voting_params(value: dependency_3.cosmos.gov.v1.VotingParams) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        ...
        get deposit_params() {
            return pb_1.Message.getWrapperField(this, dependency_3.cosmos.gov.v1.DepositParams, 2) as dependency_3.cosmos.gov.v1.DepositParams;
        }
        set deposit_params(value: dependency_3.cosmos.gov.v1.DepositParams) {
            pb_1.Message.setWrapperField(this, 2, value);
        }
        ...
        get tally_params() {
            return pb_1.Message.getWrapperField(this, dependency_3.cosmos.gov.v1.TallyParams, 3) as dependency_3.cosmos.gov.v1.TallyParams;
        }
        set tally_params(value: dependency_3.cosmos.gov.v1.TallyParams) {
        ...
        static fromObject(data: {
            voting_params?: ReturnType<typeof dependency_3.cosmos.gov.v1.VotingParams.prototype.toObject>;
            deposit_params?: ReturnType<typeof dependency_3.cosmos.gov.v1.DepositParams.prototype.toObject>;
            tally_params?: ReturnType<typeof dependency_3.cosmos.gov.v1.TallyParams.prototype.toObject>;
        }): QueryParamsResponse {
            const message = new QueryParamsResponse({});
            if (data.voting_params != null) {
                message.voting_params = dependency_3.cosmos.gov.v1.VotingParams.fromObject(data.voting_params);
            }
            if (data.deposit_params != null) {
                message.deposit_params = dependency_3.cosmos.gov.v1.DepositParams.fromObject(data.deposit_params);
            }
            if (data.tally_params != null) {
                message.tally_params = dependency_3.cosmos.gov.v1.TallyParams.fromObject(data.tally_params);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryParamsResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.voting_params, () => message.voting_params = dependency_3.cosmos.gov.v1.VotingParams.deserialize(reader));
                        break;
                    case 2:
                        reader.readMessage(message.deposit_params, () => message.deposit_params = dependency_3.cosmos.gov.v1.DepositParams.deserialize(reader));
                        break;
                    case 3:
                        reader.readMessage(message.tally_params, () => message.tally_params = dependency_3.cosmos.gov.v1.TallyParams.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class QueryDepositResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            deposit?: dependency_3.cosmos.gov.v1.Deposit;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get deposit() {
            return pb_1.Message.getWrapperField(this, dependency_3.cosmos.gov.v1.Deposit, 1) as dependency_3.cosmos.gov.v1.Deposit;
        }
        set deposit(value: dependency_3.cosmos.gov.v1.Deposit) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        get has_deposit() {
            return pb_1.Message.getField(this, 1) != null;
        ...
        static fromObject(data: {
            deposit?: ReturnType<typeof dependency_3.cosmos.gov.v1.Deposit.prototype.toObject>;
        }): QueryDepositResponse {
            const message = new QueryDepositResponse({});
            if (data.deposit != null) {
                message.deposit = dependency_3.cosmos.gov.v1.Deposit.fromObject(data.deposit);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryDepositResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.deposit, () => message.deposit = dependency_3.cosmos.gov.v1.Deposit.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class QueryDepositsResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            deposits?: dependency_3.cosmos.gov.v1.Deposit[];
            pagination?: dependency_1.cosmos.base.query.v1beta1.PageResponse;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], this.#one_of_decls);
        ...
        get deposits() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_3.cosmos.gov.v1.Deposit, 1) as dependency_3.cosmos.gov.v1.Deposit[];
        }
        set deposits(value: dependency_3.cosmos.gov.v1.Deposit[]) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        get pagination() {
            return pb_1.Message.getWrapperField(this, dependency_1.cosmos.base.query.v1beta1.PageResponse, 2) as dependency_1.cosmos.base.query.v1beta1.PageResponse;
        ...
        static fromObject(data: {
            deposits?: ReturnType<typeof dependency_3.cosmos.gov.v1.Deposit.prototype.toObject>[];
            pagination?: ReturnType<typeof dependency_1.cosmos.base.query.v1beta1.PageResponse.prototype.toObject>;
        }): QueryDepositsResponse {
            const message = new QueryDepositsResponse({});
            if (data.deposits != null) {
                message.deposits = data.deposits.map(item => dependency_3.cosmos.gov.v1.Deposit.fromObject(item));
            }
            if (data.pagination != null) {
                message.pagination = dependency_1.cosmos.base.query.v1beta1.PageResponse.fromObject(data.pagination);
            }
        ...
        toObject() {
            ...
            if (this.deposits != null) {
                data.deposits = this.deposits.map((item: dependency_3.cosmos.gov.v1.Deposit) => item.toObject());
            }
            if (this.pagination != null) {
                data.pagination = this.pagination.toObject();
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.deposits.length)
                writer.writeRepeatedMessage(1, this.deposits, (item: dependency_3.cosmos.gov.v1.Deposit) => item.serialize(writer));
            if (this.has_pagination)
                writer.writeMessage(2, this.pagination, () => this.pagination.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryDepositsResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.deposits, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_3.cosmos.gov.v1.Deposit.deserialize(reader), dependency_3.cosmos.gov.v1.Deposit));
                        break;
                    case 2:
                        reader.readMessage(message.pagination, () => message.pagination = dependency_1.cosmos.base.query.v1beta1.PageResponse.deserialize(reader));
                        break;
    ...
    export class QueryTallyResultResponse extends pb_1.Message {
        ...
        get tally() {
            return pb_1.Message.getWrapperField(this, dependency_3.cosmos.gov.v1.TallyResult, 1) as dependency_3.cosmos.gov.v1.TallyResult;
        }
        set tally(value: dependency_3.cosmos.gov.v1.TallyResult) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        get has_tally() {
            return pb_1.Message.getField(this, 1) != null;
        ...
        static fromObject(data: {
            tally?: ReturnType<typeof dependency_3.cosmos.gov.v1.TallyResult.prototype.toObject>;
        }): QueryTallyResultResponse {
            const message = new QueryTallyResultResponse({});
            if (data.tally != null) {
                message.tally = dependency_3.cosmos.gov.v1.TallyResult.fromObject(data.tally);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryTallyResultResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.tally, () => message.tally = dependency_3.cosmos.gov.v1.TallyResult.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export abstract class UnimplementedQueryService {
        static definition = {
            ...
            Proposals: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: QueryProposalsRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => QueryProposalsRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: QueryProposalsResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => QueryProposalsResponse.deserialize(new Uint8Array(bytes))
            },
            Vote: {
            ...
            Votes: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: QueryVotesRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => QueryVotesRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: QueryVotesResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => QueryVotesResponse.deserialize(new Uint8Array(bytes))
            },
            Params: {
    ...
    export class QueryClient extends grpc_1.makeGenericClientConstructor(UnimplementedQueryService.definition, "Query", {}) {
        ...
        Proposals: GrpcUnaryServiceInterface<QueryProposalsRequest, QueryProposalsResponse> = (message: QueryProposalsRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<QueryProposalsResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<QueryProposalsResponse>, callback?: grpc_1.requestCallback<QueryProposalsResponse>): grpc_1.ClientUnaryCall => {
        ...
        Votes: GrpcUnaryServiceInterface<QueryVotesRequest, QueryVotesResponse> = (message: QueryVotesRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<QueryVotesResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<QueryVotesResponse>, callback?: grpc_1.requestCallback<QueryVotesResponse>): grpc_1.ClientUnaryCall => {
