    ...
    export class Proposal extends pb_1.Message {
        ...
        static fromObject(data: {
            ...
            if (data.content != null) {
                message.content = dependency_4.google.protobuf.Any.fromObject(data.content);
            }
            if (data.status != null) {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.content, () => message.content = dependency_4.google.protobuf.Any.deserialize(reader));
                        break;
                    case 3:
