...
export namespace cosmos.slashing.v1beta1 {
    ...
    export abstract class UnimplementedQueryService {
        static definition = {
            ...
            SigningInfo: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: QuerySigningInfoRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => QuerySigningInfoRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: QuerySigningInfoResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => QuerySigningInfoResponse.deserialize(new Uint8Array(bytes))
            },
            SigningInfos: {
                path: "/cosmos.slashing.v1beta1.Query/SigningInfos",
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: QuerySigningInfosRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => QuerySigningInfosRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: QuerySigningInfosResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => QuerySigningInfosResponse.deserialize(new Uint8Array(bytes))
            }
        };
    ...
    export class QueryClient extends grpc_1.makeGenericClientConstructor(UnimplementedQueryService.definition, "Query", {}) {
        ...
        SigningInfo: GrpcUnaryServiceInterface<QuerySigningInfoRequest, QuerySigningInfoResponse> = (message: QuerySigningInfoRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<QuerySigningInfoResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<QuerySigningInfoResponse>, callback?: grpc_1.requestCallback<QuerySigningInfoResponse>): grpc_1.ClientUnaryCall => {
            return super.SigningInfo(message, metadata, options, callback);
        };
        SigningInfos: GrpcUnaryServiceInterface<QuerySigningInfosRequest, QuerySigningInfosResponse> = (message: QuerySigningInfosRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<QuerySigningInfosResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<QuerySigningInfosResponse>, callback?: grpc_1.requestCallback<QuerySigningInfosResponse>): grpc_1.ClientUnaryCall => {
