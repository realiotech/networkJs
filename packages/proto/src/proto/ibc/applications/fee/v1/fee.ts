...
export namespace ibc.applications.fee.v1 {
    export class Fee extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            recv_fee?: dependency_1.cosmos.base.v1beta1.Coin[];
            ack_fee?: dependency_1.cosmos.base.v1beta1.Coin[];
            timeout_fee?: dependency_1.cosmos.base.v1beta1.Coin[];
        }) {
            super();
        ...
        set recv_fee(value: dependency_1.cosmos.base.v1beta1.Coin[]) {
        ...
        set ack_fee(value: dependency_1.cosmos.base.v1beta1.Coin[]) {
        ...
        set timeout_fee(value: dependency_1.cosmos.base.v1beta1.Coin[]) {
            pb_1.Message.setRepeatedWrapperField(this, 3, value);
        }
        static fromObject(data: {
            recv_fee?: ReturnType<typeof dependency_1.cosmos.base.v1beta1.Coin.prototype.toObject>[];
            ack_fee?: ReturnType<typeof dependency_1.cosmos.base.v1beta1.Coin.prototype.toObject>[];
            timeout_fee?: ReturnType<typeof dependency_1.cosmos.base.v1beta1.Coin.prototype.toObject>[];
        }): Fee {
            const message = new Fee({});
            if (data.recv_fee != null) {
                message.recv_fee = data.recv_fee.map(item => dependency_1.cosmos.base.v1beta1.Coin.fromObject(item));
            }
            if (data.ack_fee != null) {
                message.ack_fee = data.ack_fee.map(item => dependency_1.cosmos.base.v1beta1.Coin.fromObject(item));
            }
            if (data.timeout_fee != null) {
                message.timeout_fee = data.timeout_fee.map(item => dependency_1.cosmos.base.v1beta1.Coin.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.recv_fee != null) {
                data.recv_fee = this.recv_fee.map((item: dependency_1.cosmos.base.v1beta1.Coin) => item.toObject());
            }
            if (this.ack_fee != null) {
                data.ack_fee = this.ack_fee.map((item: dependency_1.cosmos.base.v1beta1.Coin) => item.toObject());
            }
            if (this.timeout_fee != null) {
                data.timeout_fee = this.timeout_fee.map((item: dependency_1.cosmos.base.v1beta1.Coin) => item.toObject());
            }
            return data;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.recv_fee.length)
                writer.writeRepeatedMessage(1, this.recv_fee, (item: dependency_1.cosmos.base.v1beta1.Coin) => item.serialize(writer));
            if (this.ack_fee.length)
                writer.writeRepeatedMessage(2, this.ack_fee, (item: dependency_1.cosmos.base.v1beta1.Coin) => item.serialize(writer));
            if (this.timeout_fee.length)
                writer.writeRepeatedMessage(3, this.timeout_fee, (item: dependency_1.cosmos.base.v1beta1.Coin) => item.serialize(writer));
            if (!w)
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): Fee {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.recv_fee, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_1.cosmos.base.v1beta1.Coin.deserialize(reader), dependency_1.cosmos.base.v1beta1.Coin));
                        break;
                    case 2:
                        reader.readMessage(message.ack_fee, () => pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_1.cosmos.base.v1beta1.Coin.deserialize(reader), dependency_1.cosmos.base.v1beta1.Coin));
                        break;
                    case 3:
                        reader.readMessage(message.timeout_fee, () => pb_1.Message.addToRepeatedWrapperField(message, 3, dependency_1.cosmos.base.v1beta1.Coin.deserialize(reader), dependency_1.cosmos.base.v1beta1.Coin));
                        break;
