...
export namespace ibc.applications.interchain_accounts.genesis.v1 {
    ...
    export class ActiveChannel extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("is_middleware_enabled" in data && data.is_middleware_enabled != undefined) {
                    this.is_middleware_enabled = data.is_middleware_enabled;
                }
            }
        }
        get connection_id() {
        ...
        get is_middleware_enabled() {
            return pb_1.Message.getFieldWithDefault(this, 4, false) as boolean;
        }
        set is_middleware_enabled(value: boolean) {
        ...
        static fromObject(data: {
            ...
            if (data.is_middleware_enabled != null) {
                message.is_middleware_enabled = data.is_middleware_enabled;
            }
            return message;
        }
        toObject() {
            ...
            if (this.is_middleware_enabled != null) {
                data.is_middleware_enabled = this.is_middleware_enabled;
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.is_middleware_enabled != false)
                writer.writeBool(4, this.is_middleware_enabled);
            if (!w)
                return writer.getResultBuffer();
        }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        message.is_middleware_enabled = reader.readBool();
                        break;
                    default: reader.skipField();
                }
            }
